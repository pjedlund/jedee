 ...
 *  first, so the page re-sorts by event.start (a page concern, not a collection
 *  change). Past wants most-recent event first — the descending counterpart.
 *  Both copy the array before sorting (Array.sort mutates in place). */

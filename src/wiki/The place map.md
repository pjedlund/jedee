...
<figure class="feature" data-wiki-mockup>
  ...
  <figcaption>The same element three times, told apart only by what is slotted inside it. ⚠ Captured with the old Leaflet map and OpenStreetMap tiles, before the move to jedee's own tiles.</figcaption>
</figure>
